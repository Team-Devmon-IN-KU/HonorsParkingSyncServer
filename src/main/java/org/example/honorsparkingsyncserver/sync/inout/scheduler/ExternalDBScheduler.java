//package org.example.honorsparkingsyncserver.sync.inout.domain.scheduler;
//
...
//      List<Map<String, Object>> dataList = externalDBService.fetchData(lastReadIndex,
//          BATCH_SIZE); // DB에서 데이터 가져오기
//
//      if (!dataList.isEmpty()) {
